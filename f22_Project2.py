# Ava Webster and Kripa Srinivasan
...
.
    ...
    final_tuple = (policynumber, placetype, int(bedroomnum))
    return final_tuple
...
def write_csv(data, filename):
    ...
    first_header = ["Listing Title", "Cost", "Listing ID", "Policy Number", "Place Type", "Number of Bedrooms"]
